...
def get_afr():
  ...
  d_list_afr_homepage = postgresql_engine.execute("Select * from afr_homepage").fetchall()
  df_afr_homepage = (
  ...
  d_list_afr_street_talk = postgresql_engine.execute("Select * from afr_street_talk").fetchall()
  df_afr_street_talk = (
...
def get_aus():
  ...
  d_list_aus_homepage = postgresql_engine.execute("Select * from aus_homepage").fetchall()
  df_aus_homepage = (
